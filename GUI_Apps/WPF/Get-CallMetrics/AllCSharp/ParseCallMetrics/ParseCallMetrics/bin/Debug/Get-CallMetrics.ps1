...
# Get-CallMetrics -ExcelSpreadSheetPaths "$HOME\Downloads\call_activity_2016 December.xlsx","$HOME\Downloads\call_activity_2017_January.xlsx" -ReportType "Call Count" -ReportDirectory $HOME -CalendarDay "31" -FixSpreadSheet
