...
# Check PSPKI Module Dependency...
if (((Get-Module -ListAvailable -Name PSPKI | Select-String -Pattern PSPKI).Matches.Success) -eq $true) {
    Write-Host "PSPKI Module is available. Continuing..."
}
else {
