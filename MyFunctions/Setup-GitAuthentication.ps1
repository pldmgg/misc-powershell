    ...
    function Update-PackageManagement {
        ...
        if ($PowerShellGetLatestVersion -gt $PowerShellGetLatestLocallyAvailableVersion -and $PowerShellGetLatestVersion -gt $MinimumVer) {
            if ($PSVersionTable.PSVersion.Major -lt 5) {
                ...
                Install-Module -Name "PowerShellGet" -Scope CurrentUser -Force -WarningAction "SilentlyContinue"
            }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU2CsLvuvE39e7ev5yHI8xayiD
# R8+gggmhMIID/jCCAuagAwIBAgITawAAAAQpgJFit9ZYVQAAAAAABDANBgkqhkiG
...
# AQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSXjW6rxNwN
# eZBoq4iwy7NYjD9WDTANBgkqhkiG9w0BAQEFAASCAQBJfMoTWhC5b9y8ZXiHaD2c
# Khfe7sc/+BX/bOdWRw3vGSJy49m410JBKBW8uaIanY/40bvpQHAjz0F3b2wwjjP4
# OlQA8tmi0sEEhAES8UOY+3bcPhHicaMB1Bp5bj3z5CysQz0k5mYexclmeV8RhkhZ
# xwhBl3ThmqlkKZcEEsd6zniNDI4cnvUl/A5X33hP2e6YfczGdAHKou5x0x2Hw0AA
# Pv0xqimU7dhIoOi2W0MOHXuFtanoIB8ezLMv8o/VGef1MXbYjrc3mJ5lxrh2XOGz
# lyuCJcgCQeyNZUfqcn5MB2FWpMkHl8kWWtQXuAIbZVXQsHzzMBMbCs4EijIOvXxo
